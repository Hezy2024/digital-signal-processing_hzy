...
#         self.conv2 = nn.Conv2d(32, 64, (3, 2), (1, 2), (1, 0))
#         self.bn2 = nn.BatchNorm2d(64)
#         self.conv3 = nn.Conv2d(64, 128, 3, 1, 1)
#         self.bn3 = nn.BatchNorm2d(128)
#         self.conv4 = nn.Conv2d(128, 256, (3, 2), (1, 2), (1, 0))
#         self.bn4 = nn.BatchNorm2d(256)
#         self.conv5 = nn.Conv2d(256, 512, 3, 1, 1)
#         self.bn5 = nn.BatchNorm2d(512)
#         self.conv6 = nn.Conv2d(512, 512, (3, 2), 2)
#         self.bn6 = nn.BatchNorm2d(512)
#         self.fc1 = nn.Linear(8*512, 1024)
...
class Audio(nn.Module):
    def __init__(self):
        ...
        self.conv6 = nn.Conv2d(512, 512, (3, 2), 2)
        self.bn6 = nn.BatchNorm2d(512)
        self.conv7 = nn.Conv2d(512, 512, 3, 1, 1)  # new conv layer
        self.bn7 = nn.BatchNorm2d(512)  # new batch norm layer
        self.fc1 = nn.Linear(8*512, 2048)  # increased output nodes
        self.dropout1 = nn.Dropout(0.5)
        self.fc2 = nn.Linear(2048, 1024)  # new fc layer
        self.dropout2 = nn.Dropout(0.5)  # new dropout layer
    ...
    def forward(self, inputs, labels=None):
        ...
        out = F.relu(self.bn5(self.conv5(out)))
        out = F.relu(self.bn6(self.conv6(out)))
        out = F.relu(self.bn7(self.conv7(out)))  # new conv layer
        out = out.view(out.size(0), -1)  # flatten the tensor
        out = F.relu(self.fc1(out))
        out = self.dropout1(out)
        out = F.relu(self.fc2(out))  # new fc layer
        out = self.dropout2(out)  # new dropout layer
        out = self.fc3(out)
        if labels is not None:
            loss = nn.CrossEntropyLoss()(out, labels)
            acc = (out.argmax(dim=1) == labels).float().mean()
